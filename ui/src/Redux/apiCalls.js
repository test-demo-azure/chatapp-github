...
export const fetchChats= async(token, username) => {
    try {
        const response = await axios.get(`http://13.127.111.118:8000/api/chat?username=${username}`, {
            headers: {
...
export const createChat= async(username, friend, token) => {
    try {
        ...
        const response = await axios.post(`http://13.127.111.118:8000/api/chat/create/`, 
        {
            messages: [],
